...
import { getMoviesPageVideos } from "../store/reducers/getMoviesPageVideos";
...
export default function Movies() {
  ...
  // useEffect to fetch movies page videos when the component mounts
  useEffect(() => {
    dispatch(getMoviesPageVideos(false));
  }, [dispatch]);
    ...
    <div className="max-h-screen overflow-hidden">
      ...
      <div className="flex" style={{ height: "92.5vh" }}>
        ...
        <div className="flex flex-col">
          {/* Title */}
          <h1 className="text-3xl font-bold mb-4 mt-2 mx-auto">Movies and Trailers</h1>
          {/* Check if there are videos */}
          {videos.length ? (
            <InfiniteScroll
              // Set up infinite scrolling with relevant parameters
              dataLength={videos.length}
              next={() => dispatch(getMoviesPageVideos(true))}
