...
import { getSportsPageVideos } from "../store/reducers/getSportsPageVideos";

// Define the Sports component
export default function Sports() {
  ...
  // useEffect to fetch sports page videos when the component mounts
  useEffect(() => {
    dispatch(getSportsPageVideos(false));
  }, [dispatch]);

  // Render the Sports component
  return (
    <div className="max-h-screen overflow-hidden">
      ...
      <div className="flex" style={{ height: "92.5vh" }}>
        ...
        <div className="flex flex-col">
          {/* Title */}
          <h1 className="text-3xl font-bold mb-4 mt-2 mx-auto">Sports Videos</h1>
          {/* Check if there are videos */}
          {videos.length ? (
            <InfiniteScroll
              // Set up infinite scrolling with relevant parameters
              dataLength={videos.length}
              next={() => dispatch(getSportsPageVideos(true))}
