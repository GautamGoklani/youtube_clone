...
import { getGamingPageVideos } from "../store/reducers/getGamingPageVideos";

// Define the Gaming component
export default function Gaming() {
  ...
  // useEffect to fetch game page videos when the component mounts
  useEffect(() => {
    dispatch(getGamingPageVideos(false));
  }, [dispatch]);
    ...
    <div className="max-h-screen overflow-hidden">
      ...
      <div className="flex" style={{ height: "92.5vh" }}>
        ...
        <div className="flex flex-col">
          {/* Title */}
          <h1 className="text-3xl font-bold mb-4 mt-2 mx-auto">Gaming Videos</h1>
          {/* Check if there are videos */}
          {videos.length ? (
            <InfiniteScroll
              // Set up infinite scrolling with relevant parameters
              dataLength={videos.length}
              next={() => dispatch(getGamingPageVideos(true))}
